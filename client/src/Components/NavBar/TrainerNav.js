                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                            <ul class="navbar-nav ">
                                <li class="nav-item p-2">
                                    <Link class="nav-link nav_text_style" to="/TrainerHome">HOME</Link>
                                </li>
                                <li class="nav-item p-2">
                                    <Link class="nav-link nav_text_style" to="/Trainerabout">ABOUT</Link>
                                </li>
                                <li class="nav-item p-2">
                                    <Link class="nav-link nav_text_style" to="">PROFILE</Link>
                                </li>
                                <li class="nav-item p-2">
                                    <Link class="nav-link nav_text_style" to="/TrainerViewCourse">COURSES</Link>
                                </li>
                                <li class="nav-item p-2">
